...
export class ProductDetailsTwoComponent {
  ...
  ngOnInit(): void {
    ...
    if (this.paramsValue == "Kolo" || this.paramsValue == "kolo" || this.paramsValue == "kolo-pods") {
      this.dataSubIdParams = "648079f639df987ec9305718";
      this.dataCatIdParams = "64806d4a39df987ec93056fd";

    }
    else if (this.paramsValue == "Zest" || this.paramsValue == "zest") {
      this.dataSubIdParams = "64807a1339df987ec930571c";
      this.dataCatIdParams = "64806d4a39df987ec93056fd";
    }
    else if (this.paramsValue == "Hex" || this.paramsValue == "hex") {
      this.dataSubIdParams = "64807a2d39df987ec9305720";
      this.dataCatIdParams = "64806d5a39df987ec9305700";
    }
    else if (this.paramsValue == "Punch" || this.paramsValue == "punch") {
      this.dataSubIdParams = "64807a4a39df987ec9305724";
      this.dataCatIdParams = "64806d5a39df987ec9305700";
    }
    else if (this.paramsValue == "Cara" || this.paramsValue == "cara") {
      this.dataSubIdParams = "64807a8239df987ec9305731";
      this.dataCatIdParams = "64806d6e39df987ec9305703";
    }
    else if (this.paramsValue == "Plush" || this.paramsValue == "plush") {
      this.dataSubIdParams = "64807a9c39df987ec9305735";
      this.dataCatIdParams = "64806d6e39df987ec9305703";
    }
    else if (this.paramsValue == "Breeze" || this.paramsValue == "breeze") {
      this.dataSubIdParams = "64807ab539df987ec9305739";
      this.dataCatIdParams = "64806d6e39df987ec9305703";
    }
    else if (this.paramsValue == "Petal" || this.paramsValue == "petal") {
      this.dataSubIdParams = "64807ac739df987ec930573d";
      this.dataCatIdParams = "64806d6e39df987ec9305703";
    }
    else if (this.paramsValue == "Dome" || this.paramsValue == "dome") {
      this.dataCatIdParams = "64806d8239df987ec9305706";
      this.dataSubIdParams = "64807afa39df987ec9305744";
    }
    else if (this.paramsValue == "Nexus" || this.paramsValue == "nexus") {
      this.dataCatIdParams = "64806d8239df987ec9305706";
      this.dataSubIdParams = "64807b3539df987ec9305748";
    }
    else if (this.paramsValue == "Spark" || this.paramsValue == "spark") {
      this.dataCatIdParams = "64806d8239df987ec9305706";
      this.dataSubIdParams = "64807b4839df987ec930574c";
    }
    else if (this.paramsValue == "Instill" || this.paramsValue == "instill") {
      this.dataCatIdParams = "64806d8239df987ec9305706";
      this.dataSubIdParams = "64807b5839df987ec9305750";
    }
    else {
      this.dataSubIdParams = "";
      this.dataCatIdParams = "";
    }
