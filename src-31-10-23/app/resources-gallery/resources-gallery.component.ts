    ...
    this.resourceDocument.getResourceDetailsBySubTypeId(id).subscribe((res) => {
      if (res && typeof res === 'object') {
        ...
        this.filterResourceData = this.filterResourceData.filter((res: any) => {
          if (res.resourceSubType == id) {
            if (res.resourceSubTypeData[0].title != 'BTS') {
              console.log(res);
              return res;
            }
          }
          ...
          if (res && typeof res === 'object') {
            ...
            this.filterResourceData = this.filterResourceData.filter(
              (res: any) => {
                ...
                if (this.paramsValue == null || this.paramsValue == "All") {
            ...
            if ((this.paramsValue == null || this.paramsValue == "All") && (this.subCategorySelectedId != "648079f639df987ec9305718")) {
              this.resourceDocument
                .getResourceImageDataByCategoryProductBTSPROJECT()
                .subscribe((res) => {

                  this.dataMerge = res;
                  this.filterResourceDataMerge = this.dataMerge.data;
                  console.log("filterResourceDataMerge   ", this.filterResourceDataMerge)
                  console.log("filterResourceData  ", this.filterResourceData)
                  this.filterResourceData = this.filterResourceData.concat(this.filterResourceDataMerge);

                  // this.filterResourceDataMerge = this.filterResourceDataMerge.filter(
                  //   (res: any) => {
                  //     // console.log("res.product ", res.product);
                  //     // if (res.product != "648079f639df987ec9305718")
                  //     return res;
                  //   });
                  console.log("this.filterResourceDataHELLO ", this.filterResourceData)
                });
            }
