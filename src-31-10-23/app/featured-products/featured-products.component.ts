...
export class FeaturedProductsComponent {
  ...
  addFeaturedThreeImageMobile: File[] = [];
  ...
  featuredThreeImageChangeMobile(event: any) {
    this.addFeaturedThreeImageMobile = Array.from(event.target.files);
  ...
  ngAfterViewInit() {
    ...
    const initialData = localStorage.getItem("editfeatureProductOneDescription");
        ...
        if (
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              this.addFeaturedThreeImageMobile.forEach((file, index) => {
