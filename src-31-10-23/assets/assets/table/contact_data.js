...
$(document).ready(function () {
              ...
              var items = [];
                //var ResponseData=[];
              $.ajax({
                url:window.localStorage.getItem('BaseURLAPI')+"contactData",
                method:"GET",
            ...
            success:function(result)
            {
             //  console.log(result);
                $.each(result.data, (i, val) => {
                      ...
                      items.push({ "ID": val._id,"first_name": val.first_name,"last_name": val.last_name,"email":val.email,"mobile":val.mobile,"message":val.message});
                  })
