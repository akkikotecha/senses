...
export class InsightsTwoComponent {
  ...
  constructor(private lazyLoadService:LazyLoadingService,private InsightsServiceServiceData:InsightsServiceService,private router:Router) {
  }
  ...
  ngOnInit(): void {
    ...
    this.InsightsServiceServiceData.getThreeFeaturedProjects().subscribe((res:any)=>{
