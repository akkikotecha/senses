...
export class FeatureProductShowDetailComponent {
  constructor(private ViewAllProjectServiceAll:FeatureProductShowDetailService,private lazyLoadService:LazyLoadingService) { }
  ...
  ngOnInit(): void {
    ...
    this.ViewAllProjectServiceAll.getFeaturedProjectsDetails(localStorage.getItem("feature_project_Id")).subscribe((res:any)=>{
