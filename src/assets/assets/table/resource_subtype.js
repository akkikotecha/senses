...
$(document).ready(function () {
  ...
  //var ResponseData=[];
  $.ajax({
    url: window.localStorage.getItem("BaseURLAPI") + "getAllResourceSubType",
    method: "GET",
      ...
      $("#grid").kendoGrid({
        ...
        columns: [
          ...
          },
          {
            title: "Action",
            template:
              "<button class='btn btn-primary  edit_data ml-2' data-id='#:ID#'  data-title='#:resource_type#' data-discription='#:resource_sub_type_name#' title='Edit' ><i class='fa fa-edit text-white'></i></button><button class='btn btn-warning removeData ml-2' data-val=#: ID # title='Delete' ><i class='fa fa-trash text-white'></i></button>",
            width: 180,
            // field: "ID",
          },
        ],
