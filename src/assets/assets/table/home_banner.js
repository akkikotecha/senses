...
$(document).ready(function () {
              ...
              var items = [];
                //var ResponseData=[];
              $.ajax({
                url:window.localStorage.getItem('BaseURLAPI')+"getHomeBanner",
                method:"GET",
               ...
               console.log(result);
                $.each(result.data, (i, val) => {
                    // console.log("IMAGE : "+val.images[0]);
                      items.push({ "ID": val._id,"title": val.title,"description":val.description ,"image":val.image});
                  })
                  ...
                  $("#grid").kendoGrid({
                    ...
                    // },
                   {
                    ...
                    }, 
                    {
                        ...
                        {
                            title: "Image",
                            template: "<img src='./assets/#:image#' style='width:35%;margin-top:20px;margin-bottom:20px;'>",
                        }, 
