...
$(document).ready(function () {
  ...
  $.ajax({
    ...
    success: function (result) {
      ...
      console.log("carreres Data ", items);
...
// $("#gridData").on("click", "button.removeData", function () {
...
$("#gridData").on("click", ".status-button", function (e) {
...
$("#gridData").on("click", "button.edit_data", function () {
  $("#edit_title").val($(this).attr("data-title"));
  $("#edit_CarrerDescription").val($(this).attr("data-discription"));
