...
$(document).ready(function () {
              ...
              var items = [];
                //var ResponseData=[];
              $.ajax({
                url:window.localStorage.getItem('BaseURLAPI')+"getSubCategories",
                method:"GET",
               ...
               console.log(result);
                $.each(result.data, (i, val) => {
                    console.log("IMAGE : "+val.images[0]);
                      items.push({ "ID": val._id,"title": val.subCategoryName,"description": val.images[0]});
                  })
                  ...
                  $("#grid").kendoGrid({
                    ...
                    // },
                   {
                        ...
                        {
                            title: "Image",
                            template: "<img src='./assets/#:description#' style='width:35%;margin-top:20px;margin-bottom:20px;'>",
                        }, 
