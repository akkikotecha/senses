...
$(document).ready(function () {
  ...
  const plainTextOverview = div.textContent || div.innerText;
                    ...
                    console.log("IMAGE : "+val.subcategoriesdata[0].subCategoryName);
                      items.push({ "ID": val._id,"category": val.categoriesdata[0].categoryName,"sub_category": val.subcategoriesdata[0].subCategoryName,"overview":plainTextOverview});
                  })
...
//      console.log("HELLLLOO O "+$(this).attr('data-val'));
        ...
        $("#grid").on("click", "button.view_data", function() {
            ...
            window.location.href = window.localStorage.getItem('baseurlhostname')+"admin_product_detail_show";
            // $('#edit_id').val();
