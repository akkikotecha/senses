  ...
  $.ajax({
    ...
    success: function (result) {
      ...
      $.each(result.data, (i, val) => {
        items.push({
          job_name: val.careerJob[0].title,
          ID: val._id,
      ...
      $("#gridDataDetails").kendoGrid({
        ...
        columns: [
          ...
          },
          {
            ...
            title: "Resume",
            template:
              "#if(upload_data != '') {# <a href='#:upload_data#' target='_blank'><i class='fa fa-eye' style='font-size:20px'></i></a> #} #",
          },
        ],
        dataBound: function () {
...
$("#gridDataDetails").on("click", "button.removeData", function () {
...
$("#gridDataDetails").on("click", "button.edit_data", function () {
  //console.log("HELLO");
